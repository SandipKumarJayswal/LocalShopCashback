...
Frontend (HTML/CSS/JS) → fetch() API calls → Controller Layer → Service Layer → Repository Layer → MySQL Database
...
Run CashbackApplication.java
Open frontend/register.html in a browser to use the app, or test endpoints using Postman
Author
